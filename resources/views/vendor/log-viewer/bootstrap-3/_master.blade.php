...
<head>
    ...
    <title>LogViewer - API | Amela</title>
    <meta name="description" content="LogViewer - API | Amela">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="{{ route('log-viewer::dashboard') }}" class="navbar-brand">
                    <i class="fa fa-fw fa-book"></i> LogViewer | {{ env('APP_ENV') }}
                </a>
            </div>
    ...
    <footer class="main-footer">
        <div class="container">
            ...
            <p class="text-muted pull-right">
                Created with <i class="fa fa-heart"></i> by AMELA <sup>&copy;</sup>
            </p>
        </div>
    </footer>
